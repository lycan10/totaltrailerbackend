...
export interface ApiCartCart extends Schema.CollectionType {
  ...
  attributes: {
    ...
    quantity: Attribute.Decimal & Attribute.DefaultTo<1>;
    img: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    origin: Attribute.String;
    discountedPrice: Attribute.Float;
...
export interface ApiTopdealTopdeal extends Schema.CollectionType {
  collectionName: 'topdeals';
  info: {
    singularName: 'topdeal';
    pluralName: 'topdeals';
    displayName: 'topdeal';
  };
  options: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::topdeal.topdeal': ApiTopdealTopdeal;
